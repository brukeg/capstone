"""
Django settings for siladjango project.
...
SECRET_KEY = 'ej!8zw!bhdjwjcizc^4_^y)2!z(jn+cl0f8vm(@g42*qar(te9'
...
WSGI_APPLICATION = 'siladjango.wsgi.application'
